...
function renderGrupo(gid){{
  ...
  let dadosBase=HIST.filter(r=>cats.includes(r.categoria)&&smsFisicos.includes(r.supermercado));
  ...
  // Average series: avg across ALL supermarkets (not just selected ones)
  if(showAvg){{
